...
<qgis minScale="1e+08" version="3.34.2-Prizren" maxScale="0" styleCategories="AllStyleCategories" hasScaleBasedVisibilityFlag="0">
  <flags>
  ...
  <elevation enabled="0" zoffset="0" symbology="Line" band="1" zscale="1">
    ...
    <profileLineSymbol>
      <symbol is_animated="0" type="line" clip_to_extent="1" alpha="1" frame_rate="10" name="" force_rhr="0">
        ...
        <layer locked="0" id="{10da7da6-b83b-4c88-865a-9e956db090b5}" pass="0" class="SimpleLine" enabled="1">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol is_animated="0" type="fill" clip_to_extent="1" alpha="1" frame_rate="10" name="" force_rhr="0">
        ...
        <layer locked="0" id="{ac445eb1-9464-4200-ac13-c2fee5516deb}" pass="0" class="SimpleFill" enabled="1">
          <Option type="Map">
  ...
  <pipe>
    ...
    <rasterrenderer opacity="1" gradient="BlackToWhite" alphaBand="-1" type="singlebandgray" grayBand="1" nodataColor="">
      <rasterTransparency/>
      <minMaxOrigin>
    ...
    <huesaturation grayscaleMode="0" colorizeOn="0" colorizeRed="255" invertColors="0" colorizeBlue="128" colorizeStrength="100" colorizeGreen="128" saturation="0"/>
